...
var DJInfo = (() => {
  var __create = Object.create,
      ...
      if ((t && "object" == typeof t) || "function" == typeof t)
        for (let n of __getOwnPropNames(t))
          __hasOwnProp.call(e, n) ||
            ...
            __defProp(e, n, {
              get: () => t[n],
              enumerable: !(i = __getOwnPropDesc(t, n)) || i.enumerable,
            });
      return e;
    },
    __toESM = (e, t, r) => (
    ...
    require_base64 = __commonJS({
      "node_modules/@protobufjs/base64/index.js"(e) {
        ...
        t.encode = function (e, t, r) {
          for (var n, o = null, s = [], a = 0, l = 0; t < r; ) {
            var u = e[t++];
            switch (l) {
              case 0:
                ((s[a++] = i[u >> 2]), (n = (3 & u) << 4), (l = 1));
                break;
              case 1:
                ((s[a++] = i[n | (u >> 4)]), (n = (15 & u) << 2), (l = 2));
                break;
              case 2:
                ((s[a++] = i[n | (u >> 6)]), (s[a++] = i[63 & u]), (l = 0));
            }
            a > 8191 &&
        ...
        ((t.decode = function (e, t, r) {
          for (var i, s = r, a = 0, l = 0; l < e.length; ) {
              ...
              : (function () {
                  function t(e, t, r, i, n, o) {
                    ...
                    if ((s && (i = -i), 0 === i))
                      ...
                      if (i < 22250738585072014e-324)
                        ...
                        (1024 === l && (l = 1023),
                          e(
                            (4503599627370496 * (a = i * Math.pow(2, -l))) >>>
                              0,
                            n,
                            o + t,
                          ),
                  ...
                  function r(e, t, r, i, n) {
                    ...
                    return 2047 === l
                      ...
                      : 0 === l
                        ? 5e-324 * a * u
                        : a * Math.pow(2, l - 1075) * (u + 4503599627370496);
                  }
    ...
    require_minimal = __commonJS({
      "node_modules/protobufjs/src/util/minimal.js"(e) {
        ...
        ((t.asPromise = require_aspromise()),
          (t.base64 = require_base64()),
          (t.EventEmitter = require_eventemitter()),
          (t.float = require_float()),
          (t.inquire = require_inquire()),
          (t.utf8 = require_utf8()),
          (t.pool = require_pool()),
          (t.LongBits = require_longbits()),
          (t.isNode = Boolean(
          ...
          (t.longFromHash = function (e, r) {
            var i = t.LongBits.fromHash(e);
            return t.Long
              ? t.Long.fromBits(i.lo, i.hi, r)
              : i.toNumber(Boolean(r));
          }),
          (t.merge = r),
    ...
    require_writer = __commonJS({
      "node_modules/protobufjs/src/writer.js"(e, t) {
        ...
        ((c.create = d()),
          ...
          i.Array !== Array &&
            (c.alloc = i.pool(c.alloc, i.Array.prototype.subarray)),
          ...
          (c.prototype.int32 = function (e) {
            return e < 0 ? this._push(h, 10, n.fromNumber(e)) : this.uint32(e);
          }),
          ...
          (c.prototype.reset = function () {
            return (
              this.states
                ...
                : ((this.head = this.tail = new a(l, 0, 0)), (this.len = 0)),
              this
            );
          }),
      ...
      "node_modules/protobufjs/src/writer_buffer.js"(e, t) {
        ...
        ((n._configure = function () {
          ...
          (n.prototype.bytes = function (e) {
            ...
            return (
              this.uint32(t),
              t && this._push(n.writeBytesBuffer, t, e),
              this
            );
          }),
    ...
    require_reader_buffer = __commonJS({
      "node_modules/protobufjs/src/reader_buffer.js"(e, t) {
        ...
        ((n._configure = function () {
          i.Buffer && (n.prototype._slice = i.Buffer.prototype.slice);
        }),
    ...
    require_service = __commonJS({
      "node_modules/protobufjs/src/rpc/service.js"(e, t) {
        ...
        (((i.prototype = Object.create(r.EventEmitter.prototype)).constructor =
          i),
          (i.prototype.rpcCall = function e(t, i, n, o, s) {
            if (!o) throw TypeError("request must be specified");
            var a = this;
            if (!s) return r.asPromise(e, a, t, i, n, o);
            if (a.rpcImpl)
              try {
                return a.rpcImpl(
                  t,
    ...
    require_index_minimal = __commonJS({
      "node_modules/protobufjs/src/index-minimal.js"(e) {
        ...
        ((t.build = "minimal"),
          (t.Writer = require_writer()),
          (t.BufferWriter = require_writer_buffer()),
          (t.Reader = require_reader()),
          (t.BufferReader = require_reader_buffer()),
          (t.util = require_minimal()),
          (t.rpc = require_rpc()),
          (t.roots = require_roots()),
          (t.configure = r),
          r());
      },
    }),
    require_codegen = __commonJS({
      "node_modules/@protobufjs/codegen/index.js"(e, t) {
        "use strict";
        function r(e, t) {
            ...
            if ("string" != typeof e) {
              ...
              if (
                ...
                for (
                  ...
                  ((a[u] = s[u]), (l[u] = e[s[u++]]));
                return ((a[u] = t), Function.apply(null, a).apply(null, l));
              }
              return Function(t)();
            }
    ...
    require_fetch = __commonJS({
      "node_modules/@protobufjs/fetch/index.js"(e, t) {
        "use strict";
        t.exports = n;
        var r = require_aspromise(),
          i = require_inquire()("fs");
        function n(e, t, o) {
          return (
            "function" == typeof t ? ((o = t), (t = {})) : t || (t = {}),
            o
              ? !t.xhr && i && i.readFile
                ? i.readFile(e, function (r, i) {
                    return r && "undefined" != typeof XMLHttpRequest
                      ? n.xhr(e, t, o)
                      : r
                        ? o(r)
                        : o(null, t.binary ? i : i.toString("utf8"));
                  })
                : n.xhr(e, t, o)
              : r(n, this, e, t)
          );
    ...
    require_path = __commonJS({
      "node_modules/@protobufjs/path/index.js"(e) {
        "use strict";
        var t = e,
          r = (t.isAbsolute = function (e) {
            return /^(?:\/|\w+:)/.test(e);
          }),
          i = (t.normalize = function (e) {
    ...
    require_namespace = __commonJS({
      "node_modules/protobufjs/src/namespace.js"(e, t) {
        "use strict";
        t.exports = c;
        var r = require_object();
        ((c.prototype = Object.create(r.prototype)).constructor = c).className =
          "Namespace";
        var i,
          n,
          o,
        ...
        function d(e) {
          ((e._nestedArray = null), (e._lookupCache = {}));
          for (var t = e; (t = t.parent); ) t._lookupCache = {};
          return e;
        }
        ((c.fromJSON = function (e, t) {
          ...
          Object.defineProperty(c.prototype, "nestedArray", {
            get: function () {
              return (
                this._nestedArray ||
                (this._nestedArray = a.toArray(this.nested))
              );
            },
          }),
          ...
          (c.prototype.add = function (e) {
            if (
              !(
                (e instanceof s && void 0 !== e.extend) ||
                e instanceof i ||
                e instanceof l ||
                e instanceof o ||
                e instanceof n ||
            ...
            if (this.nested) {
              ...
              if (t) {
                if (
                  !(t instanceof c && e instanceof c) ||
                  t instanceof i ||
                  t instanceof n
                )
                  throw Error("duplicate name '" + e.name + "' in " + this);
                for (var r = t.nestedArray, a = 0; a < r.length; ++a)
                  e.add(r[a]);
                (this.remove(t),
            ...
            ((this.nested[e.name] = e),
              ...
              (this._needsRecursiveFeatureResolution = !0),
              (this._needsRecursiveResolve = !0));
            for (var u = this; (u = u.parent); )
              ((u._needsRecursiveFeatureResolution = !0),
                (u._needsRecursiveResolve = !0));
            return (e.onAdd(this), d(this));
          }),
          ...
          (c.prototype.define = function (e, t) {
            ...
            for (var r = this; e.length > 0; ) {
              ...
              if (r.nested && r.nested[i]) {
                if (!((r = r.nested[i]) instanceof c))
                  throw Error("path conflicts with non-namespace objects");
              } else r.add((r = new c(i)));
            }
          ...
          (c.prototype.lookup = function (e, t, r) {
            ...
            var n =
              ...
              this.root._fullyQualifiedObjects["." + i];
            if (n && (!t || t.indexOf(n.constructor) > -1)) return n;
            if (
              (n = this._lookupImpl(e, i)) &&
              (!t || t.indexOf(n.constructor) > -1)
            )
              return n;
            if (r) return null;
            for (var o = this; o.parent; ) {
              if (
                (n = o.parent._lookupImpl(e, i)) &&
                (!t || t.indexOf(n.constructor) > -1)
              )
                return n;
              o = o.parent;
          ...
          (c.prototype._lookupImpl = function (e, t) {
            if (Object.prototype.hasOwnProperty.call(this._lookupCache, t))
              return this._lookupCache[t];
            var r = this.get(e[0]),
              i = null;
            if (r)
              1 === e.length
                ? (i = r)
                : r instanceof c &&
                  ((e = e.slice(1)), (i = r._lookupImpl(e, e.join("."))));
            else
              for (var n = 0; n < this.nestedArray.length; ++n)
                this._nestedArray[n] instanceof c &&
                  (r = this._nestedArray[n]._lookupImpl(e, t)) &&
                  (i = r);
            return ((this._lookupCache[t] = i), i);
          }),
    ...
    require_mapfield = __commonJS({
      "node_modules/protobufjs/src/mapfield.js"(e, t) {
        "use strict";
        t.exports = o;
        var r = require_field();
        ((o.prototype = Object.create(r.prototype)).constructor = o).className =
          "MapField";
        var i = require_types(),
          n = require_util();
        function o(e, t, i, o, s, a) {
          if ((r.call(this, e, t, o, void 0, void 0, s, a), !n.isString(i)))
        ...
        ((o.fromJSON = function (e, t) {
          ...
          (o.d = function (e, t, r) {
            return (
              "function" == typeof r
                ? (r = n.decorateType(r).name)
                : r && "object" == typeof r && (r = n.decorateEnum(r).name),
              function (i, s) {
                n.decorateType(i.constructor).add(new o(s, e, t, r));
              }
            );
          }));
      },
    }),
    require_method = __commonJS({
      "node_modules/protobufjs/src/method.js"(e, t) {
        "use strict";
        t.exports = n;
        var r = require_object();
        ((n.prototype = Object.create(r.prototype)).constructor = n).className =
          "Method";
        var i = require_util();
        function n(e, t, n, o, s, a, l, u, c) {
          if (
            (i.isObject(s)
              ? ((l = s), (s = a = void 0))
              : i.isObject(a) && ((l = a), (a = void 0)),
    ...
    require_service2 = __commonJS({
      "node_modules/protobufjs/src/service.js"(e, t) {
        "use strict";
        t.exports = s;
        var r = require_namespace();
        ((s.prototype = Object.create(r.prototype)).constructor = s).className =
          "Service";
        var i = require_method(),
          n = require_util(),
          o = require_rpc();
        function s(e, t) {
          (r.call(this, e, t),
        ...
        ((s.fromJSON = function (e, t) {
          ...
          return (
            ...
            t.edition && (r._edition = t.edition),
            (r.comment = t.comment),
          ...
          (s.prototype.toJSON = function (e) {
            ...
            return n.toObject([
              ...
              (t && t.options) || void 0,
              "methods",
              r.arrayToJSON(this.methodsArray, e) || {},
              "nested",
              (t && t.nested) || void 0,
              "comment",
          ...
          Object.defineProperty(s.prototype, "methodsArray", {
            get: function () {
              return (
                this._methodsArray ||
                (this._methodsArray = n.toArray(this.methods))
              );
            },
          }),
          ...
          (s.prototype._resolveFeaturesRecursive = function (e) {
            return this._needsRecursiveFeatureResolution
              ? ((e = this._edition || e),
                r.prototype._resolveFeaturesRecursive.call(this, e),
          ...
          (s.prototype.add = function (e) {
            ...
            return e instanceof i
              ? ((this.methods[e.name] = e), (e.parent = this), a(this))
          ...
          (s.prototype.remove = function (e) {
            if (e instanceof i) {
              if (this.methods[e.name] !== e)
                throw Error(e + " is not a member of " + this);
              return (delete this.methods[e.name], (e.parent = null), a(this));
            }
            return r.prototype.remove.call(this, e);
          }),
          (s.prototype.create = function (e, t, r) {
            for (
              var i, s = new o.Service(e, t, r), a = 0;
              a < this.methodsArray.length;
              ++a
            ) {
              var l = n
                .lcFirst((i = this._methodsArray[a]).resolve().name)
                .replace(/[^$\w_]/g, "");
              s[l] = n.codegen(
                ["r", "c"],
                n.isReserved(l) ? l + "_" : l,
    ...
    require_message = __commonJS({
      "node_modules/protobufjs/src/message.js"(e, t) {
        "use strict";
        t.exports = i;
        var r = require_minimal();
        function i(e) {
    ...
    require_decoder = __commonJS({
      "node_modules/protobufjs/src/decoder.js"(e, t) {
        "use strict";
        t.exports = function (e) {
          for (
            ...
            var a = e._fieldsArray[s].resolve(),
              l = a.resolvedType instanceof r ? "int32" : a.type,
              u = "m" + n.safeProp(a.name);
            (t("case %i: {", a.id),
              a.map
                ? (t("if(%s===util.emptyObject)", u)("%s={}", u)(
                  ...
                  void 0 === i.basic[l]
                    ? t("value=types[%i].decode(r,r.uint32())", s)
                    : t("value=r.%s()", l),
          ...
          for (
            t("default:")("r.skipType(t&7)")("break")("}")("}"), s = 0;
            s < e._fieldsArray.length;
            ++s
          ) {
            var c = e._fieldsArray[s];
            c.required &&
              t("if(!m.hasOwnProperty(%j))", c.name)(
    ...
    require_verifier = __commonJS({
      "node_modules/protobufjs/src/verifier.js"(e, t) {
        "use strict";
        t.exports = function (e) {
          var t = i.codegen(
              ["m"],
          ...
          for (var a = 0; a < e.fieldsArray.length; ++a) {
            var l = e._fieldsArray[a].resolve(),
              u = "m" + i.safeProp(l.name);
            if (
              (l.optional &&
                t("if(%s!=null&&m.hasOwnProperty(%j)){", u, l.name),
              l.map)
            )
              (t("if(!util.isObject(%s))", u)("return%j", n(l, "object"))(
                "var k=Object.keys(%s)",
                u,
              ...
              (t("if(!Array.isArray(%s))", u)("return%j", n(l, "array"))(
              ...
              if (l.partOf) {
                var c = i.safeProp(l.partOf.name);
                (1 === r[l.partOf.name] &&
                  t("if(p%s===1)", c)(
                    "return%j",
        ...
        function o(e, t, i, o) {
          if (t.resolvedType)
            if (t.resolvedType instanceof r) {
              e("switch(%s){", o)("default:")("return%j", n(t, "enum value"));
              for (
              ...
              e("{")("var e=types[%i].verify(%s);", i, o)("if(e)")(
                "return%j+e",
                t.name + ".",
              )("}");
          else
            switch (t.type) {
              ...
              case "fixed32":
              case "sfixed32":
                e("if(!util.isInteger(%s))", o)("return%j", n(t, "integer"));
                break;
              case "int64":
              case "uint64":
              case "sint64":
              ...
              case "float":
              case "double":
                e('if(typeof %s!=="number")', o)("return%j", n(t, "number"));
                break;
              case "bool":
                e('if(typeof %s!=="boolean")', o)("return%j", n(t, "boolean"));
                break;
              case "string":
                e("if(!util.isString(%s))", o)("return%j", n(t, "string"));
                break;
              case "bytes":
                e(
    ...
    require_converter = __commonJS({
      "node_modules/protobufjs/src/converter.js"(e) {
        "use strict";
        var t = e,
          r = require_enum(),
          i = require_util();
        function n(e, t, i, n) {
          ...
          if (t.resolvedType)
            if (t.resolvedType instanceof r) {
              e("switch(d%s){", n);
              for (
                var s = t.resolvedType.values, a = Object.keys(s), l = 0;
                l < a.length;
                ++l
              )
                (s[a[l]] !== t.typeDefault ||
                  ...
                  t.repeated || e("break"),
                  (o = !0)),
                  e("case%j:", a[l])("case %i:", s[a[l]])("m%s=%j", n, s[a[l]])(
                    "break",
                  ));
              e("}");
            } else
              ...
              )("m%s=types[%i].fromObject(d%s)", n, i, n);
          else {
            var u = !1;
            switch (t.type) {
              case "double":
        ...
        ((t.fromObject = function (e) {
          ...
          if (!t.length) return o("return new this.ctor");
          o("var m=new this.ctor");
          for (var s = 0; s < t.length; ++s) {
            var a = t[s].resolve(),
              l = i.safeProp(a.name);
            a.map
              ? (o("if(d%s){", l)('if(typeof d%s!=="object")', l)(
                  "throw TypeError(%j)",
                ...
                n(o, a, s, l + "[ks[i]]")("}")("}"))
              : a.repeated
                ? (o("if(d%s){", l)("if(!Array.isArray(d%s))", l)(
                    "throw TypeError(%j)",
                    a.fullName + ": array expected",
                  )("m%s=[]", l)("for(var i=0;i<d%s.length;++i){", l),
                  n(o, a, s, l + "[i]")("}")("}"))
                : (a.resolvedType instanceof r || o("if(d%s!=null){", l),
                  n(o, a, s, l),
                  a.resolvedType instanceof r || o("}"));
          }
          return o("return m");
        }),
          (t.toObject = function (e) {
            ...
            for (
              var n = i.codegen(["m", "o"], e.name + "$toObject")("if(!o)")(
                  "o={}",
                )("var d={}"),
                s = [],
                a = [],
              ...
              t[u].partOf ||
                (t[u].resolve().repeated ? s : t[u].map ? a : l).push(t[u]);
            if (s.length) {
              for (n("if(o.arrays||o.defaults){"), u = 0; u < s.length; ++u)
                n("d%s=[]", i.safeProp(s[u].name));
              n("}");
            }
            if (a.length) {
              for (n("if(o.objects||o.defaults){"), u = 0; u < a.length; ++u)
                n("d%s={}", i.safeProp(a[u].name));
              n("}");
            }
            if (l.length) {
              for (n("if(o.defaults){"), u = 0; u < l.length; ++u) {
                ...
                if (c.resolvedType instanceof r)
                  ...
                  var f =
                    "[" +
                    Array.prototype.slice.call(c.typeDefault).join(",") +
                    "]";
                  n(
            ...
            for (u = 0; u < t.length; ++u) {
              c = t[u];
              var h = e._fieldsArray.indexOf(c);
              ((d = i.safeProp(c.name)),
                c.map
                  ? (p || ((p = !0), n("var ks2")),
                    n(
                    ...
                    o(n, c, h, d + "[ks2[j]]")("}"))
                  : c.repeated
                    ? (n("if(m%s&&m%s.length){", d, d)("d%s=[]", d)(
                        "for(var j=0;j<m%s.length;++j){",
                        d,
                      ),
                      o(n, c, h, d + "[j]")("}"))
                    : (n("if(m%s!=null&&m.hasOwnProperty(%j)){", d, c.name),
                      o(n, c, h, d),
                      c.partOf &&
                        n("if(o.oneofs)")(
                          "d%s=%j",
                          i.safeProp(c.partOf.name),
                          c.name,
                        )),
                n("}"));
            }
    ...
    require_wrappers = __commonJS({
      "node_modules/protobufjs/src/wrappers.js"(e) {
        "use strict";
        var t = e,
          r = require_message();
    ...
    require_type = __commonJS({
      "node_modules/protobufjs/src/type.js"(e, t) {
        "use strict";
        t.exports = v;
        var r = require_namespace();
        ((v.prototype = Object.create(r.prototype)).constructor = v).className =
          "Type";
        var i = require_enum(),
          n = require_oneof(),
          o = require_field(),
        ...
        (Object.defineProperties(v.prototype, {
          ...
          fieldsArray: {
            get: function () {
              return (
                this._fieldsArray ||
                (this._fieldsArray = d.toArray(this.fields))
              );
            },
          },
          oneofsArray: {
            get: function () {
              return (
                this._oneofsArray ||
                (this._oneofsArray = d.toArray(this.oneofs))
              );
            },
          },
          ctor: {
          ...
          (v.generateConstructor = function (e) {
            for (
              var t, r = d.codegen(["p"], e.name), i = 0;
          ...
          (v.fromJSON = function (e, t) {
            var l = new v(e, t.options);
            ((l.extensions = t.extensions), (l.reserved = t.reserved));
            for (var u = Object.keys(t.fields), c = 0; c < u.length; ++c)
              l.add(
                (void 0 !== t.fields[u[c]].keyType ? s.fromJSON : o.fromJSON)(
                  u[c],
                  t.fields[u[c]],
                ),
              );
            if (t.oneofs)
              for (u = Object.keys(t.oneofs), c = 0; c < u.length; ++c)
                l.add(n.fromJSON(u[c], t.oneofs[u[c]]));
            if (t.nested)
              for (u = Object.keys(t.nested), c = 0; c < u.length; ++c) {
                var d = t.nested[u[c]];
                l.add(
                  (void 0 !== d.id
                    ? o.fromJSON
            ...
            return (
              ...
              t.edition && (l._edition = t.edition),
              (l._defaultEdition = "proto3"),
              l
            );
          }),
          (v.prototype.toJSON = function (e) {
            ...
            return d.toObject([
              ...
              (t && t.options) || void 0,
              "oneofs",
              r.arrayToJSON(this.oneofsArray, e),
              "fields",
              r.arrayToJSON(
          ...
          (v.prototype.resolveAll = function () {
            if (!this._needsRecursiveResolve) return this;
            r.prototype.resolveAll.call(this);
            var e = this.oneofsArray;
            for (i = 0; i < e.length; ) e[i++].resolve();
            for (var t = this.fieldsArray, i = 0; i < t.length; )
              t[i++].resolve();
            return this;
          }),
          (v.prototype._resolveFeaturesRecursive = function (e) {
            return this._needsRecursiveFeatureResolution
              ? ((e = this._edition || e),
                r.prototype._resolveFeaturesRecursive.call(this, e),
                this.oneofsArray.forEach((t) => {
                  t._resolveFeatures(e);
                }),
          ...
          (v.prototype.setup = function () {
            ...
            ((this.encode = f(this)({ Writer: c, types: t, util: d })),
              (this.decode = p(this)({ Reader: u, types: t, util: d })),
              (this.verify = h(this)({ types: t, util: d })),
              (this.fromObject = m.fromObject(this)({ types: t, util: d })),
              (this.toObject = m.toObject(this)({ types: t, util: d })));
            var i = y[e];
            if (i) {
    ...
    require_root = __commonJS({
      "node_modules/protobufjs/src/root.js"(e, t) {
        "use strict";
        t.exports = c;
        var r = require_namespace();
        ((c.prototype = Object.create(r.prototype)).constructor = c).className =
        ...
        ((c.fromJSON = function (e, t) {
          return (
            ...
            t.addJSON(e.nested).resolveAll()
          );
        }),
          (c.prototype.resolvePath = u.path.resolve),
          (c.prototype.fetch = u.fetch),
          (c.prototype.load = function e(t, r, i) {
            "function" == typeof r && ((i = r), (r = void 0));
            var s = this;
            if (!i) return u.asPromise(e, s, t, r);
            var a = i === d;
            function l(e, t) {
              if (i) {
                if (a) throw e;
                ...
                if (
                  ...
                  if (o.imports)
                    for (; d < o.imports.length; ++d)
                      (i = c(o.imports[d]) || s.resolvePath(e, o.imports[d])) &&
                        p(i);
                  if (o.weakImports)
                    for (d = 0; d < o.weakImports.length; ++d)
                      (i =
                        c(o.weakImports[d]) ||
                        s.resolvePath(e, o.weakImports[d])) && p(i, !0);
            ...
            function p(e, t) {
              if (((e = c(e) || e), !(s.files.indexOf(e) > -1)))
                if ((s.files.push(e), e in o))
                  a
                    ? f(e, o[e])
                    : (++h,
                      setTimeout(function () {
                  ...
                  (++h,
                    s.fetch(e, function (r, n) {
                      (--h, i && (r ? (t ? h || l(null, s) : l(r)) : f(e, n)));
                    }));
            }
            var h = 0;
            u.isString(t) && (t = [t]);
            for (var m, y = 0; y < t.length; ++y)
              (m = s.resolvePath("", t[y])) && p(m);
            return a ? (s.resolveAll(), s) : (h || l(null, s), s);
          }),
        ...
        function p(e, t) {
          ...
          if (r) {
            var i = new s(t.fullName, t.id, t.type, t.rule, void 0, t.options);
            return (
              r.get(i.name) ||
                ((i.declaringField = t), (t.extensionField = i), r.add(i)),
              !0
            );
          }
          return !1;
        ...
        ((c.prototype._handleAdd = function (e) {
          ...
          (e instanceof i || e instanceof a || e instanceof s) &&
            (this._fullyQualifiedObjects[e.fullName] = e);
        }),
    ...
    require_util = __commonJS({
      "node_modules/protobufjs/src/util.js"(e, t) {
        "use strict";
        var r,
          i,
          n = (t.exports = require_minimal()),
          o = require_roots();
        ((n.codegen = require_codegen()),
          (n.fetch = require_fetch()),
          (n.path = require_path()),
          (n.fs = n.inquire("fs")),
        ...
        ((n.isReserved = function (e) {
          ...
          (n.safeProp = function (e) {
            return !/^[$\w_]+$/.test(e) || n.isReserved(e)
              ? '["' + e.replace(s, "\\\\").replace(a, '\\"') + '"]'
              : "." + e;
          }),
        ...
        ((n.camelCase = function (e) {
          ...
          (n.decorateType = function (e, t) {
            if (e.$type)
              return (
                t &&
                  e.$type.name !== t &&
                  (n.decorateRoot.remove(e.$type),
                  (e.$type.name = t),
                  n.decorateRoot.add(e.$type)),
                e.$type
              );
            r || (r = require_type());
            var i = new r(t || e.name);
            return (
              n.decorateRoot.add(i),
              (i.ctor = e),
        ...
        ((n.decorateEnum = function (e) {
          ...
          Object.defineProperty(n, "decorateRoot", {
            get: function () {
              return o.decorated || (o.decorated = new (require_root())());
            },
          }));
      },
    }),
    require_types = __commonJS({
      "node_modules/protobufjs/src/types.js"(e) {
        "use strict";
        var t = e,
          r = require_util(),
          i = [
        ...
        ((t.basic = n([1, 5, 0, 0, 0, 5, 5, 0, 0, 0, 1, 1, 0, 2, 2])),
          (t.defaults = n([
            0,
            0,
            0,
          ...
          (t.long = n([0, 0, 0, 1, 1], 7)),
          (t.mapKey = n([0, 0, 0, 5, 5, 0, 0, 0, 1, 1, 0, 2], 2)),
          (t.packed = n([1, 5, 0, 0, 0, 5, 5, 0, 0, 0, 1, 1, 0])));
      },
    }),
    require_field = __commonJS({
      "node_modules/protobufjs/src/field.js"(e, t) {
        "use strict";
        t.exports = l;
        var r = require_object();
        ...
        function l(e, t, i, n, l, u, c) {
          if (
            (s.isObject(n)
              ? ((c = l), (u = n), (n = l = void 0))
              : s.isObject(l) && ((c = u), (u = l), (l = void 0)),
            r.call(this, e, u),
            !s.isInteger(t) || t < 0)
          )
            throw TypeError("id must be a non-negative integer");
          if (!s.isString(i)) throw TypeError("type must be a string");
          if (void 0 !== n && !a.test((n = n.toString().toLowerCase())))
            throw TypeError("rule must be a string rule");
          if (void 0 !== l && !s.isString(l))
            throw TypeError("extend must be a string");
          ("proto3_optional" === n && (n = "optional"),
            (this.rule = n && "optional" !== n ? n : void 0),
            (this.type = i),
            (this.id = t),
            (this.extend = l || void 0),
            ...
            (this.long = !!s.Long && void 0 !== o.long[i]),
            (this.bytes = "bytes" === i),
        ...
        ((l.fromJSON = function (e, t) {
          ...
          Object.defineProperty(l.prototype, "required", {
            get: function () {
              return "LEGACY_REQUIRED" === this._features.field_presence;
            },
          }),
          Object.defineProperty(l.prototype, "optional", {
            get: function () {
              return !this.required;
            },
          }),
          Object.defineProperty(l.prototype, "delimited", {
            get: function () {
              return (
                this.resolvedType instanceof i &&
                "DELIMITED" === this._features.message_encoding
              );
            },
          }),
          ...
          Object.defineProperty(l.prototype, "hasPresence", {
            get: function () {
              return (
                !this.repeated &&
                !this.map &&
          ...
          (l.prototype.resolve = function () {
            ...
            if (
              ...
              ((this.typeDefault = s.Long.fromNumber(
                this.typeDefault,
              ...
              var e;
              (s.base64.test(this.typeDefault)
                ? s.base64.decode(
                    this.typeDefault,
                    (e = s.newBuffer(s.base64.length(this.typeDefault))),
                    0,
                  )
                : s.utf8.write(
                    this.typeDefault,
                    (e = s.newBuffer(s.utf8.length(this.typeDefault))),
                    0,
                  ),
                (this.typeDefault = e));
            }
            return (
              this.map
                ? (this.defaultValue = s.emptyObject)
                : this.repeated
                  ? (this.defaultValue = s.emptyArray)
          ...
          (l.prototype._inferLegacyProtoFeatures = function (e) {
            if ("proto2" !== e && "proto3" !== e) return {};
            var t = {};
            if (
              ("required" === this.rule &&
                (t.field_presence = "LEGACY_REQUIRED"),
              this.parent && void 0 === o.defaults[this.type])
            ) {
          ...
          (l.prototype._resolveFeatures = function (e) {
            return r.prototype._resolveFeatures.call(this, this._edition || e);
          }),
          (l.d = function (e, t, r, i) {
            return (
              "function" == typeof t
                ? (t = s.decorateType(t).name)
                : t && "object" == typeof t && (t = s.decorateEnum(t).name),
              function (n, o) {
                s.decorateType(n.constructor).add(
                  new l(o, e, t, r, { default: i }),
                );
              }
            );
          }),
    ...
    require_oneof = __commonJS({
      "node_modules/protobufjs/src/oneof.js"(e, t) {
        "use strict";
        t.exports = o;
        var r = require_object();
        ((o.prototype = Object.create(r.prototype)).constructor = o).className =
        ...
        ((o.fromJSON = function (e, t) {
          ...
          Object.defineProperty(o.prototype, "isProto3Optional", {
            get: function () {
              if (null == this.fieldsArray || 1 !== this.fieldsArray.length)
                return !1;
              var e = this.fieldsArray[0];
              return null != e.options && !0 === e.options.proto3_optional;
            },
          }),
          (o.d = function () {
            for (
              ...
              e[t] = arguments[t++];
            return function (t, r) {
              (n.decorateType(t.constructor).add(new o(r, e)),
    ...
    require_object = __commonJS({
      "node_modules/protobufjs/src/object.js"(e, t) {
        "use strict";
        ((t.exports = u), (u.className = "ReflectionObject"));
        var r,
          i = require_oneof(),
          n = require_util(),
          o = {
        ...
        (Object.defineProperties(u.prototype, {
          ...
          (u.prototype.resolve = function () {
            return (
              this.resolved || (this.root instanceof r && (this.resolved = !0)),
              this
            );
          }),
          (u.prototype._resolveFeaturesRecursive = function (e) {
            return this._resolveFeatures(this._edition || e);
          }),
          (u.prototype._resolveFeatures = function (e) {
            if (!this._featuresResolved) {
              ...
              if (this._edition) {
                if ("proto2" === e) t = Object.assign({}, a);
                else if ("proto3" === e) t = Object.assign({}, l);
                else if ("2023" === e) t = Object.assign({}, s);
                else {
                  if ("2024" !== e) throw new Error("Unknown edition: " + e);
                  t = Object.assign({}, o);
                }
                return (
                  (this._features = Object.assign(t, r || {})),
                  void (this._featuresResolved = !0)
                );
              }
              if (this.partOf instanceof i) {
                var n = Object.assign({}, this.partOf._features);
                ...
                this._features = Object.assign(u, r || {});
              }
              (this.extensionField &&
          ...
          (u.prototype._inferLegacyProtoFeatures = function () {
            return {};
          }),
          ...
          (u.prototype.setOption = function (e, t, r) {
            return (
              ...
              /^features\./.test(e)
                ? n.setProperty(this.options, e, t, r)
                : (r && void 0 !== this.options[e]) ||
                  (this.getOption(e) !== t && (this.resolved = !1),
                  (this.options[e] = t)),
              this
            );
          }),
          ...
          (u.prototype._editionToJSON = function () {
            if (this._edition && "proto3" !== this._edition)
    ...
    require_enum = __commonJS({
      "node_modules/protobufjs/src/enum.js"(e, t) {
        "use strict";
        t.exports = o;
        var r = require_object();
        ((o.prototype = Object.create(r.prototype)).constructor = o).className =
          "Enum";
        var i = require_namespace(),
          n = require_util();
        function o(e, t, i, n, o, s) {
          if ((r.call(this, e, i), t && "object" != typeof t))
        ...
        ((o.prototype._resolveFeatures = function (e) {
          return (
            (e = this._edition || e),
            r.prototype._resolveFeatures.call(this, e),
            Object.keys(this.values).forEach((e) => {
              var t = Object.assign({}, this._features);
              this._valuesFeatures[e] = Object.assign(
                t,
                this.valuesOptions &&
                  this.valuesOptions[e] &&
                  this.valuesOptions[e].features,
              );
            }),
            this
          );
          ...
          (o.prototype.add = function (e, t, r, i) {
            if (!n.isString(e)) throw TypeError("name must be a string");
    ...
    require_encoder = __commonJS({
      "node_modules/protobufjs/src/encoder.js"(e, t) {
        "use strict";
        t.exports = function (e) {
          for (
            var t,
              s = n.codegen(["m", "w"], e.name + "$encode")("if(!w)")(
                "w=Writer.create()",
              ),
              a = e.fieldsArray.slice().sort(n.compareFieldsById),
              l = 0;
            l < a.length;
            ++l
          ) {
            var u = a[l].resolve(),
              c = e._fieldsArray.indexOf(u),
              d = u.resolvedType instanceof r ? "int32" : u.type,
              f = i.basic[d];
            ((t = "m" + n.safeProp(u.name)),
              u.map
                ? (s(
                  ...
                  void 0 === f
                    ...
                    : s(".uint32(%i).%s(%s[ks[i]]).ldelim()", 16 | f, d, t),
                  s("}")("}"))
                : u.repeated
                  ? (s("if(%s!=null&&%s.length){", t, t),
                    u.packed && void 0 !== i.packed[d]
                      ? s("w.uint32(%i).fork()", ((u.id << 3) | 2) >>> 0)(
                          "for(var i=0;i<%s.length;++i)",
                          t,
                        )(
                          "w.%s(%s[i])",
    ...
    require_index_light = __commonJS({
      "node_modules/protobufjs/src/index-light.js"(e, t) {
        "use strict";
        var r = (t.exports = require_index_minimal());
        ((r.build = "light"),
          ...
          (r.encoder = require_encoder()),
          (r.decoder = require_decoder()),
          (r.verifier = require_verifier()),
          (r.converter = require_converter()),
          (r.ReflectionObject = require_object()),
          (r.Namespace = require_namespace()),
          (r.Root = require_root()),
          (r.Enum = require_enum()),
          (r.Type = require_type()),
          (r.Field = require_field()),
          (r.OneOf = require_oneof()),
          (r.MapField = require_mapfield()),
          (r.Service = require_service2()),
          (r.Method = require_method()),
          (r.Message = require_message()),
          (r.wrappers = require_wrappers()),
          (r.types = require_types()),
          (r.util = require_util()),
    ...
    require_light = __commonJS({
      "node_modules/protobufjs/light.js"(e, t) {
        "use strict";
        t.exports = require_index_light();
      },
    }),
    ...
    STYLE_ID = "dj-info-styles";
  function initStyles() {
    let e = document.getElementById(STYLE_ID);
    (e ||
  ...
  var CONFIG_MODAL_CSS =
      '\n.setting-row::after {\n    content: "";\n    display: table;\n    clear: both;\n    border-radius: 4px;\n}\n.setting-row .col {\n    display: flex;\n    padding: 10px 0;\n    align-items: center;\n}\n.setting-row .col.description {\n    float: left;\n    padding-right: 15px;\n    color: var(--spice-text);\n}\n.setting-row .col.action {\n    float: right;\n    text-align: right;\n}\nh1.main-type-alto {\n  color: var(--spice-text);\n}\nbutton.switch {\n    align-items: center;\n    border: 0px;\n    border-radius: 50%;\n    background-color: rgba(var(--spice-rgb-shadow), .7);\n    color: var(--spice-text);\n    cursor: pointer;\n    display: flex;\n    margin-inline-start: 12px;\n    padding: 8px;\n}\nbutton.switch.disabled,\nbutton.switch[disabled] {\n    color: rgba(var(--spice-rgb-text), .3);\n}\nbutton.btn {\n    font-weight: 700;\n    font-size: medium;\n    background-color: transparent;\n    border-radius: 24px;\n    transition-duration: 33ms;\n    transition-property: background-color, border-color, color, box-shadow, filter, transform;\n    padding-inline: 15px;\n    border: 1px solid #727272;\n    color: var(--spice-text);\n    min-block-size: 32px;\n    cursor: pointer;\n}\nbutton.btn:hover {\n    transform: scale(1.04);\n    border-color: var(--spice-text);\n}\n',
    DEFAULT_CONFIG = {
      isPlaylistEnabled: !0,
      isNowPlayingEnabled: !0,
      isLeftPlayingEnabled: !1,
      isRecommendationsEnabled: !0,
      isBPMEnabled: !0,
      isKeyEnabled: !1,
      isCamelotEnabled: !0,
      isPopularityEnabled: !0,
      isEnergyEnabled: !1,
      isDanceEnabled: !1,
      isYearEnabled: !0,
      isRichUiEnabled: !0,
  ...
  var getReact = () => Spicetify.React,
    DisplayIcon = ({ icon: e, size: t }) =>
      getReact().createElement("svg", {
        width: t,
        height: t,
        viewBox: "0 0 16 16",
        fill: "currentColor",
    ...
    ConfigItem = ({ name: e, field: t, disabled: r = !1 }) => {
      const i = getReact(),
        [n, o] = i.useState(CONFIG[t]);
      return i.createElement(
        "div",
        { className: "setting-row" },
        i.createElement("label", { className: "col description" }, e),
        i.createElement(
          "div",
          ...
          i.createElement(
            "button",
            {
              className: "switch" + (n ? "" : " disabled"),
              disabled: r,
              onClick: () => {
                const e = !n;
                ((CONFIG[t] = e), o(e), saveConfig());
              },
            },
            i.createElement(DisplayIcon, {
    ...
    ReloadItem = ({ name: e, disabled: t = !1 }) => {
      const r = getReact();
      return r.createElement(
        "div",
        { className: "setting-row" },
        r.createElement("label", { className: "col description" }, e),
        r.createElement(
          "div",
          { className: "col action" },
          r.createElement(
  ...
  function openConfig() {
    const e = getReact2(),
      t = e.createElement("style", {
        dangerouslySetInnerHTML: { __html: CONFIG_MODAL_CSS },
      }),
      r = e.createElement(
        "div",
        null,
        t,
        e.createElement(ConfigItem, {
        ...
        e.createElement(ReloadItem, { name: "Reload Window to apply changes" }),
      );
    Spicetify.PopupModal.display({ title: "DJ Info Settings", content: r });
  }
  ...
  var DjTrackInfo = class {
      static fromQueries(e, t) {
        return {
          key: e.key,
          mode: e.mode,
          tempo: Math.round(e.tempo),
          energy: Math.round(100 * e.energy),
          danceability: Math.round(100 * e.danceability),
          popularity: t.popularity,
          release_date: t.release_date.split("-")[0],
        };
      }
    },
    trackDb = {},
    idb = {
      ...
      init: () => (
        idb.initPromise ||
          (idb.initPromise = new Promise((e, t) => {
            const r = indexedDB.open("dj-info-idb", 1);
            ((r.onupgradeneeded = (e) => {
              const t = e.target.result;
              t.objectStoreNames.contains("tracks") ||
                t.createObjectStore("tracks", { keyPath: "id" });
            }),
              (r.onsuccess = (t) => {
                ((idb.db = t.target.result), e());
              }),
              (r.onerror = (e) => {
                (console.error("DJ Info: IndexedDB error", e), t(e));
              }));
          })),
        idb.initPromise
      ),
      get: async (e) => (
        idb.db || (await idb.init()),
        new Promise((t) => {
          const r = idb.db
          ...
          ((r.onsuccess = () => {
            var e;
            return t((null == (e = r.result) ? void 0 : e.val) || null);
          }),
            (r.onerror = () => t(null)));
        })
      ),
      getMany: async (e) => (
        ...
        new Promise((t) => {
          ...
          e.forEach((o) => {
            ...
            ((s.onsuccess = () => {
              var r;
              ((null == (r = s.result) ? void 0 : r.val) &&
                i.push({ id: o, val: s.result.val }),
                n++,
                n === e.length && t(i));
            }),
              (s.onerror = () => {
      ...
      setMany: async (e) => (
        idb.db || (await idb.init()),
        new Promise((t) => {
          const r = idb.db.transaction(["tracks"], "readwrite"),
            i = r.objectStore("tracks");
          (e.forEach((e) => i.put({ id: e.id, val: e.val })),
            (r.oncomplete = () => t()),
            (r.onerror = () => t()));
        })
      ),
  ...
  async function migrateLocalStorage() {
    const e = "dj-info-tracks",
      t = Spicetify.LocalStorage.get(e);
    if (t) {
      ...
      try {
        ...
        (Object.keys(r).forEach((e) => {
          ...
          i.length > 0 &&
            (await idb.setMany(i),
            console.log(`DJ Info: Migrated ${i.length} tracks.`)),
          Spicetify.LocalStorage.remove(e),
  ...
  function cleanupOldStorage() {
    const e = [];
    for (let t = 0; t < Spicetify.LocalStorage.length; t++) {
      const r = Spicetify.LocalStorage.key(t);
      r.startsWith("djinfo-") &&
        "dj-info-tracks" !== r &&
        "dj-info-config" !== r &&
        e.push(r);
    }
    (e.forEach((e) => Spicetify.LocalStorage.remove(e)),
      e.length > 0 && console.log("DJ Info: Cleaned up old/legacy keys."));
  }
  function initTrackDb() {
    (idb.init().then(migrateLocalStorage), cleanupOldStorage());
  }
  var extendedMetadataJsonDescriptor = {
      nested: {
        Message: {
          fields: {
        ...
        Query: { fields: { extension_kind: { type: "uint32", id: 1 } } },
      },
    },
    audioFeaturesJsonDescriptor = {
      nested: {
        ...
        Header: { fields: { status: { type: "uint32", id: 1 } } },
        Response: {
          fields: {
        ...
        ResponseInfo: { fields: { status: { type: "uint32", id: 1 } } },
    ...
    extendedMetadataRequest = null,
    audioFeaturesResponse = null,
    trackMetadataResponse = null;
  function getProtobufTypes() {
    return (
      ...
      {
        extendedMetadataRequest: extendedMetadataRequest,
        audioFeaturesResponse: audioFeaturesResponse,
        trackMetadataResponse: trackMetadataResponse,
      }
    );
  }
  var country = "US",
  ...
  async function initProductState() {
    var e, t;
    const r = await Spicetify.Platform.ProductStateAPI.getValues();
    ((country = null != (e = r.country) ? e : "US"),
      (catalogue = null != (t = r.catalogue) ? t : "premium"));
  }
  async function getExtendedMetadata(e, t) {
    const { extendedMetadataRequest: r } = getProtobufTypes(),
      i = new Uint8Array(16);
    crypto.getRandomValues(i);
    const n = r
        .encode({
          header: { country: country, catalogue: catalogue, task_id: i },
          request: e.map((e) => ({
            entity_uri: e,
            query: { extension_kind: t },
          })),
        })
        .finish(),
      o = await fetch(
  ...
  async function getFeatures(e) {
    const { audioFeaturesResponse: t } = getProtobufTypes(),
      r = await getExtendedMetadata(
        e.map((e) => `spotify:track:${e}`),
        222,
      );
    return t.decode(r).response.map((e) => {
      if (!e.attributes) return null;
      const t = e.attributes.attributes;
      return {
        id: e.track.split(":")[2],
        tempo: t.bpm,
        key: "C C# D D# E F F# G G# A A# B".split(" ").indexOf(t.key.key),
        mode: t.key.majorMinor - 1,
      };
    });
  }
  async function getTrackFeatures(e) {
    const { trackMetadataResponse: t } = getProtobufTypes(),
      r = await getExtendedMetadata(
        e.map((e) => `spotify:track:${e}`),
        10,
      );
    return t.decode(r).response.map((e) => {
      ...
      const t = e.metadata.metadata,
        r = t.album.release_date,
        i = `${null == r ? void 0 : r.year}-${((null == r ? void 0 : r.month) + "").padStart(2, "0")}-${((null == r ? void 0 : r.day) + "").padStart(2, "0")}`;
      return {
        id: e.track.split(":")[2],
        popularity: t.popularity,
        release_date: i,
  ...
  async function getTrackInfo(e) {
    if (trackDb[e]) return trackDb[e];
    const t = await idb.get(e);
    if (t) return ((trackDb[e] = t), t);
    const [r] = await getTrackInfoBatch([e]);
    return r;
  }
  async function getTrackInfoBatch(e) {
    const t = e.filter((e) => !trackDb[e]);
    let r = t;
    if (
      (t.length > 0 &&
        ((await idb.getMany(t)).forEach((e) => {
          trackDb[e.id] = e.val;
        }),
        (r = t.filter((e) => !trackDb[e]))),
      r.length > 0)
    )
      try {
        const e = await Promise.allSettled([
          ...
          t = "fulfilled" === e[0].status ? e[0].value : null,
          i = "fulfilled" === e[1].status ? e[1].value : null;
        if (t) {
          const e = [];
          (t.forEach((t) => {
            if (t) {
              ...
              if (r) {
                const i = DjTrackInfo.fromQueries(t, r);
                ((trackDb[t.id] = i), e.push({ id: t.id, val: i }));
              }
            }
          }),
            e.length > 0 && (await idb.setMany(e)));
        }
      } catch (e) {
        console.error("DJ Info: Error fetching batch track info:", e);
      }
    return e.map((e) => (trackDb[e] ? trackDb[e] : null));
  }
  var trackInfoQueue = new Map(),
    trackInfoTimeout = null,
    addInfoToTrackFn = null;
  function setAddInfoToTrack(e) {
    addInfoToTrackFn = e;
  }
  async function processTrackInfoQueue() {
    if (0 === trackInfoQueue.size) return;
    const e = Array.from(trackInfoQueue.keys()),
      t = new Map(trackInfoQueue);
    trackInfoQueue.clear();
    for (let t = 0; t < e.length; t += 100) {
      const r = e.slice(t, t + 100);
      await getTrackInfoBatch(r);
    }
    t.forEach((e, t) => {
      trackDb[t] &&
        addInfoToTrackFn &&
        e.forEach((e) => {
          if (e && e.isConnected) {
            const t = null !== e.closest('[data-testid="recommended-track"]');
            addInfoToTrackFn(e, t);
          }
        });
    });
  }
  function queueTrackInfo(e, t) {
    (trackInfoQueue.has(e) || trackInfoQueue.set(e, new Set()),
      trackInfoQueue.get(e).add(t),
      clearTimeout(trackInfoTimeout),
      (trackInfoTimeout = setTimeout(processTrackInfoQueue, 100)));
  }
  function getTracklistTrackUri(e) {
    var t,
      r,
      i,
      n,
        ...
        (s =
          ...
          (o =
            ...
            (n =
              null ==
              (i =
                null == (r = null == (t = te[0]) ? void 0 : t.pendingProps)
                  ? void 0
                  : r.children[0])
                ? void 0
                : i.props)
              ...
              (f =
                ...
                (d =
                  ...
                  (c =
                    ...
                    (u =
                      null ==
                      (l = null == (a = te[0]) ? void 0 : a.pendingProps)
                        ? void 0
                        : l.children[0])
                      ? void 0
                      : u.props)
                  ...
                  (_ =
                    ...
                    (b =
                      ...
                      (g =
                        ...
                        (v =
                          null ==
                          (y = null == (m = te[0]) ? void 0 : m.pendingProps)
                            ? void 0
                            : y.children[0])
                          ? void 0
                          : v.props)
          ...
          (I =
            ...
            (A =
              ...
              (x =
                null ==
                (S =
                  null == (E = null == (C = te[0]) ? void 0 : C.pendingProps)
                    ? void 0
                    : E.children[0])
                  ? void 0
                  : S.props)
          ...
          (F =
            ...
            (R =
              ...
              (P =
                null ==
                (q =
                  null == (N = null == (T = te[0]) ? void 0 : T.pendingProps)
                    ? void 0
                    : N.children)
                  ? void 0
                  : q.props)
              ...
              (G =
                ...
                (M =
                  ...
                  (J =
                    ...
                    (D =
                      null ==
                      (B = null == (L = te[0]) ? void 0 : L.pendingProps)
                        ? void 0
                        : B.children)
                      ? void 0
                      : D.props)
          ...
          (ee =
                  ...
                  (Y =
                    ...
                    (V =
                      ...
                      (K =
                        ...
                        (H =
                          null ==
                          (W = null == (U = te[0]) ? void 0 : U.pendingProps)
                            ? void 0
                            : W.children)
                          ? void 0
                          : H.props)
            ...
            ? void 0
            : ee.uri)
      : (console.log("Error: Could not get tracklist element"), null);
  }
  function getKeyInNotation(e, t) {
    const r = e < 0 || t < 0 ? "XX" : ((7 * e + [4, 7][t]) % 12) + 1 + "AB"[t],
      i =
        e < 0
          ? "XX"
          : "C Db D Eb E F F♯ G Ab A Bb B".split(" ")[e] + ["m", "", "?"].at(t);
    return CONFIG.isCamelotEnabled
      ? CONFIG.isKeyEnabled
        ? `${i}&nbsp;(${r})`
        : r
      : i;
  }
  var fourColumnGridCss =
    ...
    queueTrackInfoFn = null;
  function setQueueTrackInfo(e) {
    queueTrackInfoFn = e;
  }
  var getVisibleColumnCount = (e) => {
      let t = 0;
      const r = Array.from(e.children);
      for (const e of r)
        !e.classList.contains("djInfoList") &&
          (e.classList.contains("main-trackList-rowSectionVariable") ||
            e.classList.contains("main-trackList-rowSectionEnd") ||
            e.classList.contains("main-trackList-rowSectionStart") ||
            e.classList.contains("main-trackList-rowSectionIndex")) &&
    ...
    updateTrackGrid = (e, t) => {
      ...
      let i = e.querySelector(".djInfoList");
      if (r < 550 && !t)
        return (
          i && (i.style.display = "none"),
          void (e.style["grid-template-columns"] = "")
        );
      i && (i.style.display = "flex");
      const n = getVisibleColumnCount(e);
      if (t)
        (i && ((i.style.justifyContent = "center"), (i.style.width = "100%")),
          (e.style["grid-template-columns"] = recommendationGridCss));
      else if (CONFIG.isRichUiEnabled)
        switch (n) {
          case 3:
            e.style["grid-template-columns"] = richFourColumnGridCss;
            break;
          case 4:
            e.style["grid-template-columns"] = richFiveColumnGridCss;
            break;
          case 5:
            e.style["grid-template-columns"] = richSixColumnGridCss;
            break;
          case 6:
            e.style["grid-template-columns"] = richSevenColumnGridCss;
        }
      else
        switch (n) {
          case 3:
            e.style["grid-template-columns"] = fourColumnGridCss;
            break;
          case 4:
            e.style["grid-template-columns"] = fiveColumnGridCss;
            break;
          case 5:
            e.style["grid-template-columns"] = sixColumnGridCss;
            break;
          case 6:
            e.style["grid-template-columns"] = sevenColumnGridCss;
        }
    };
  function addInfoToTrack(e, t = !1) {
    const r = null !== e.querySelector(".djinfo"),
      i = getTracklistTrackUri(e);
    if (!i) return;
    const n = i.includes("track");
    let o = e.querySelector(".djInfoList");
    if (!o) {
      let t = e.querySelector(".main-trackList-rowSectionEnd");
      if (t) {
        let r = getVisibleColumnCount(e);
        (t.setAttribute("aria-colindex", (r + 1).toString()),
          (o = document.createElement("div")),
          o.setAttribute("aria-colindex", r.toString()),
          (o.style.display = "flex"),
          o.classList.add("main-trackList-rowSectionVariable"),
          o.classList.add("djInfoList"),
          e.insertBefore(o, t));
      }
    }
    if ((o && updateTrackGrid(e, t), !i || !n)) return;
    const s = i.split(":")[2],
      a = trackDb[s];
    if (a) {
      if (r) return;
      if (CONFIG.isRichUiEnabled && o) {
        const e = a,
          t = document.createElement("div");
        t.className = "dj-info-grid djinfo djinfo-animate";
        const r = document.createElement("div");
        if (
          ((r.className = "dj-info-row-top"),
          CONFIG.isKeyEnabled || CONFIG.isCamelotEnabled)
        ) {
          const t = getKeyInNotation(e.key, e.mode),
            i = document.createElement("span");
          if (
            ((i.className = "dj-info-tag"),
            (i.innerText = t),
            CONFIG.isCamelotEnabled)
          ) {
            const e = t.match(/(\d+[AB])/);
            e
              ? i.classList.add(`camelot-key-${e[1]}`)
              : (i.style.backgroundColor = "#e0e0e0");
          } else i.style.backgroundColor = "#e0e0e0";
          r.appendChild(i);
        }
        if (CONFIG.isBPMEnabled) {
          const t = document.createElement("span");
          ((t.innerText = `${e.tempo} bpm`), r.appendChild(t));
        }
        const i = document.createElement("div");
        i.className = "dj-info-row-bottom";
        let n = [];
        (CONFIG.isEnergyEnabled && n.push(`E: ${e.energy}`),
          CONFIG.isDanceEnabled && n.push(`D: ${e.danceability}`),
          CONFIG.isPopularityEnabled && n.push(`♥ ${e.popularity}`),
          CONFIG.isYearEnabled && n.push(`${e.release_date}`),
          n.length > 0 &&
            n.forEach((e, t) => {
              const r = document.createElement("span");
              if (((r.innerText = e), i.appendChild(r), t < n.length - 1)) {
                const e = document.createElement("span");
                ((e.className = "dj-info-separator"),
                  (e.innerText = "-"),
                  i.appendChild(e));
              }
            }),
          t.appendChild(r),
          n.length > 0 && t.appendChild(i),
          (o.innerHTML = ""),
          o.appendChild(t));
      } else if (o) {
        const e = a,
          t = getKeyInNotation(e.key, e.mode),
          r = document.createElement("div");
        r.className = "dj-info-classic-container djinfo djinfo-animate";
        const i = [],
          n = [];
        if (CONFIG.isKeyEnabled || CONFIG.isCamelotEnabled) {
          i.push("𝄞 " + t);
          const e = CONFIG.isKeyEnabled && CONFIG.isCamelotEnabled ? 1.9 : 0.8;
          n.push(e);
        }
        (CONFIG.isBPMEnabled && (i.push(Math.round(e.tempo) + " ♫"), n.push(1)),
          CONFIG.isEnergyEnabled && (i.push("E " + e.energy), n.push(0.8)),
          CONFIG.isDanceEnabled && (i.push("D " + e.danceability), n.push(0.8)),
          CONFIG.isPopularityEnabled &&
            (i.push("♥ " + e.popularity), n.push(0.75)),
          CONFIG.isYearEnabled && (i.push(e.release_date), n.push(0.9)));
        const s = [];
        (n.forEach((e, t) => {
          (s.push(`minmax(0, ${e}fr)`),
            t < n.length - 1 && s.push("max-content"));
        }),
          (r.style["grid-template-columns"] = s.join(" ")),
          i.forEach((e, t) => {
            const n = document.createElement("span");
            if (
              ((n.className = "dj-info-classic-item"),
              (n.innerText = e),
              r.appendChild(n),
              t < i.length - 1)
            ) {
              const e = document.createElement("span");
              ((e.className = "dj-info-classic-separator"),
                (e.innerText = "|"),
                r.appendChild(e));
            }
          }),
      ...
      if (r) {
        const t = e.querySelector(".djinfo");
        t && t.remove();
      }
      queueTrackInfoFn && queueTrackInfoFn(s, e);
    }
  }
  function updateTracklist(e, t) {
    if (!CONFIG.isPlaylistEnabled) return;
    if (!e) return;
    const r = e.querySelector(".main-trackList-trackListHeaderRow");
    if (r && !r.querySelector(".djinfoheader")) {
      let e = r.querySelector(".main-trackList-rowSectionEnd"),
        t = getVisibleColumnCount(r);
      e.setAttribute("aria-colindex", (t + 1).toString());
      let i = document.createElement("div");
      if (
        ((i.style.display = "flex"),
        i.classList.add("main-trackList-rowSectionVariable"),
        (i.role = "columnheader"),
        r.insertBefore(i, e),
        CONFIG.isRichUiEnabled)
      )
        switch (t) {
          case 3:
            r.style["grid-template-columns"] = richFourColumnGridCss;
            break;
          case 4:
            r.style["grid-template-columns"] = richFiveColumnGridCss;
            break;
          case 5:
            r.style["grid-template-columns"] = richSixColumnGridCss;
            break;
          case 6:
            r.style["grid-template-columns"] = richSevenColumnGridCss;
        }
      else
        switch (t) {
          case 3:
            r.style["grid-template-columns"] = fourColumnGridCss;
            break;
          case 4:
            r.style["grid-template-columns"] = fiveColumnGridCss;
            break;
          case 5:
            r.style["grid-template-columns"] = sixColumnGridCss;
            break;
          case 6:
            r.style["grid-template-columns"] = sevenColumnGridCss;
        }
      const n = document.createElement("button");
      (n.classList.add("main-trackList-column"),
        n.classList.add("main-trackList-sortable"),
        n.classList.add("djinfoheader"));
      const o = document.createElement("span");
      (o.classList.add("TypeElement-mesto-type"),
        o.classList.add("standalone-ellipsis-one-line"),
        (o.innerHTML = "DJ Info"),
        n.appendChild(o),
        i.appendChild(n));
    }
    const i = e.getElementsByClassName("main-trackList-trackListRow");
    for (const e of i) {
      const r = null !== e.querySelector(".djinfo");
      (e.classList.contains("dj-observed") && r) ||
        (e.classList.add("dj-observed"), t.observe(e));
    }
  }
  function updateRecommendations(e, t) {
    if (!CONFIG.isRecommendationsEnabled) return;
    if (!e) return;
    const r = e.querySelector(".main-trackList-trackList");
    if (r) {
      const e = r.getElementsByClassName("main-trackList-trackListRow");
      for (const r of e) {
        const e = null !== r.querySelector(".djinfo");
        (r.classList.contains("dj-observed") && e) ||
          (r.classList.add("dj-observed"), t.observe(r));
      }
    }
  }
  var nowPlayingWidgetdjInfoData = null;
  function setNowPlayingElement(e) {
    nowPlayingWidgetdjInfoData = e;
  }
  async function updateNowPlayingWidget() {
    if (!nowPlayingWidgetdjInfoData || !CONFIG.isNowPlayingEnabled) return;
    const e =
      Spicetify.Player.data && Spicetify.Player.data.item
        ? Spicetify.Player.data.item.uri
        : null;
    if (!e) return void (nowPlayingWidgetdjInfoData.style.display = "none");
    const t = e.includes("track");
    nowPlayingWidgetdjInfoData.style.display = t ? "flex" : "none";
    const r = e;
    if ("local" === r.split(":")[1])
      return void (nowPlayingWidgetdjInfoData.innerHTML = "");
    const i = r.split(":")[2],
      n = await getTrackInfo(i);
    if (n) {
      const e = [];
      ((CONFIG.isKeyEnabled || CONFIG.isCamelotEnabled) &&
        e.push(`${getKeyInNotation(n.key, n.mode)}`),
        CONFIG.isBPMEnabled && e.push(`${n.tempo} ♫`),
        CONFIG.isEnergyEnabled && e.push(`E ${n.energy}`),
        CONFIG.isDanceEnabled && e.push(`D ${n.danceability}`),
        CONFIG.isPopularityEnabled && e.push(`♥ ${n.popularity}`),
        CONFIG.isYearEnabled && e.push(`${n.release_date}`),
        (nowPlayingWidgetdjInfoData.innerHTML = e.join("<br>")),
        nowPlayingWidgetdjInfoData.classList.remove("djinfo-animate"),
        nowPlayingWidgetdjInfoData.offsetWidth,
        nowPlayingWidgetdjInfoData.classList.add("djinfo-animate"));
    } else
      ((nowPlayingWidgetdjInfoData.innerHTML = ""),
        getTrackInfo(i).then((e) => {
          e && updateNowPlayingWidget();
        }));
    nowPlayingWidgetdjInfoData.style.fontSize = "11px";
  }
  function initNowPlayingListener() {
    Spicetify.Player.addEventListener("songchange", () => {
      updateNowPlayingWidget();
    });
  }
  ((globalThis.protobuf = import_light.default),
    (async function e() {
      for (; !Spicetify.showNotification; )
        await new Promise((e) => setTimeout(e, 500));
      const { CosmosAsync: t, URI: r } = Spicetify;
      if (!t || !r) return void setTimeout(e, 300);
      (loadConfig(),
        initStyles(),
        initTrackDb(),
        ...
        window.djInfoObserver && window.djInfoObserver.disconnect());
      const i = new IntersectionObserver(
        (e) => {
          e.forEach((e) => {
            if (e.isIntersecting) {
              const t = e.target,
                r = null !== t.closest('[data-testid="recommended-track"]');
              (addInfoToTrack(t, r), i.unobserve(t));
            }
          });
        },
        { rootMargin: "200px" },
      );
      window.djInfoObserver = i;
      const n = new WeakSet();
      let o = null,
        s = null;
      function a(e, t = !1) {
        const r = () => {
          t ? updateRecommendations(e, i) : updateTracklist(e, i);
        };
        (n.has(e) ||
          (new MutationObserver(r).observe(e, { childList: !0, subtree: !0 }),
          n.add(e)),
          r());
      }
      function l() {
        document
          .querySelectorAll(".main-trackList-indexable")
          .forEach((e) => a(e, !1));
        const e = document.querySelector('[data-testid="recommended-track"]');
        if (
          (e && a(e, !0),
          (o = s),
          (s = document.querySelector(".main-nowPlayingWidget-nowPlaying")),
          s && !s.isEqualNode(o) && !s.querySelector(".dj-info-now-playing"))
        ) {
          const e = document.createElement("p");
          (e.classList.add("dj-info-now-playing"),
            (e.style.marginLeft = "4px"),
            (e.style.marginRight = "4px"),
            (e.style.minWidth = "34px"),
            (e.style.fontSize = "11px"),
            (e.style.textAlign = "center"));
          const t = s.querySelector(".main-trackInfo-container");
          (t && (CONFIG.isLeftPlayingEnabled ? t.before(e) : t.after(e)),
            setNowPlayingElement(e),
            updateNowPlayingWidget());
        }
      }
      const u = debounce(l, 10);
      window.djInfoMutationObserver &&
        window.djInfoMutationObserver.disconnect();
      const c = new MutationObserver(u);
      (l(),
        c.observe(document.body, { childList: !0, subtree: !0 }),
        (window.djInfoMutationObserver = c));
    })());
})();
